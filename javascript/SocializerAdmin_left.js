...
SiteTreeHandlers.loadPage_url = 'admin/socializer/getitem';
SiteTreeHandlers.controller_url = 'admin/socializer';
...
Behaviour.addLoader(function () {
    ...
    $('addlink').getElementsByTagName('button')[0].onclick = function() {
        return false;
    };
